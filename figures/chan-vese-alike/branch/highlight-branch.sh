...
BASE_IMAGE="${SCRIPT_FOLDER}/input/branch-noisy.pgm"
DATA_FOLDER="${SCRIPT_FOLDER}/data/noisy/curvature/2"
OUTPUT_FOLDER="${PROJECT_FOLDER}/figures/chan-vese-alike/output/chan-vese-alike/branch"
...
convert_to_png "${BASE_IMAGE}" "${OUTPUT_FOLDER}/branch-noisy.png"
mogrify -crop 120x120+90+90 "${OUTPUT_FOLDER}/branch-noisy.png"
