...
BASE_IMAGE="${SCRIPT_FOLDER}/input/line-cuts-noisy.pgm"
DATA_FOLDER="${SCRIPT_FOLDER}/data/noisy/curvature/2"
OUTPUT_FOLDER="${PROJECT_FOLDER}/figures/chan-vese-alike/output/chan-vese-alike/line-cuts"
...
convert_to_png "${BASE_IMAGE}" "${OUTPUT_FOLDER}/line-cuts-noisy.png"
mogrify -crop 120x120+90+90 "${OUTPUT_FOLDER}/line-cuts-noisy.png"
