#ifndef GRAPH_FLOW_PAPER_FIGURES_FIGURES_FIND_GRID_STEP_INCLUDE_ENERGY_H_
#define GRAPH_FLOW_PAPER_FIGURES_FIGURES_FIND_GRID_STEP_INCLUDE_ENERGY_H_
...
#endif //GRAPH_FLOW_PAPER_FIGURES_FIGURES_FIND_GRID_STEP_INCLUDE_ENERGY_H_
